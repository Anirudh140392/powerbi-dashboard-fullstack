            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-4 md:inset-x-[10%] md:inset-y-[5%] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl z-[61] flex flex-col overflow-hidden border border-slate-200/50 dark:border-slate-700/50"
                    >
                        {/* Header */}
