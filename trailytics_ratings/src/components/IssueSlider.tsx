    ...
    return (
        <>
            {createPortal(
                <AnimatePresence>
                    {isOpen && (
                        <div key="issue-slider-root" className="fixed inset-0 z-[1300] pointer-events-none">
                            {/* Backdrop */}
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                            ...
                            <motion.div
                                ...
                                className="absolute top-0 right-0 h-full w-full max-w-lg bg-white dark:bg-slate-900 shadow-2xl flex flex-col pointer-events-auto"
                            >
                                {/* Header */}
