...
async function main() {
    ...
    function toCandidate(row) {
        // Canonicalize web_pid to UPPERCASE so it matches product_snapshots /
        // masters.products (case-sensitive joins). Some upstream rows arrive
        // lowercased; uppercase is the canonical form for Flipkart/Amazon ids.
