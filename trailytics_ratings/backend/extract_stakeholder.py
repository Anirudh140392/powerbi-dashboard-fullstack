...
if __name__ == "__main__":
    ...
    sigs = [
        "app.get('/api/ratings/stakeholder-detail'",
        "app.get('/api/ratings/stakeholder-mappings'",
        "app.post('/api/ratings/stakeholder-mappings'",
        "app.delete('/api/ratings/stakeholder-mappings/:id'"
    ]
    
    results = extract_routes(file_path, sigs)
    
    names = {
        "app.get('/api/ratings/stakeholder-detail'": "getStakeholderDetail",
        "app.get('/api/ratings/stakeholder-mappings'": "getStakeholderMappings",
        "app.post('/api/ratings/stakeholder-mappings'": "createStakeholderMapping",
        "app.delete('/api/ratings/stakeholder-mappings/:id'": "deleteStakeholderMapping"
    }

    with open('src/controllers/stakeholder/stakeholder.controller.js', 'w') as out:
