// src/routes/admin.js
import { getUsers, deleteUser, getLiveUsers, getPendingRequests, updateUserAccess, getPermissionsUsers, updateDbStatus, updateTabPermissions, updateKpiPermissions, getDatabases, updateDatabaseLogo, createDatabase, createUser, createWalkthroughNotification, getAdminPlatforms } from '../controllers/adminController.js';
...
export default (app) => {
    ...
    app.patch('/api/admin/permissions/kpi-permissions', updateKpiPermissions);
    /**
     * @swagger
     * /api/admin/databases:
     *   get:
     ...
     * /api/admin/platforms:
     *   get:
     *     summary: Get unique active platforms
     *     security:
     *       - bearerAuth: []
     *     responses:
     *       200:
