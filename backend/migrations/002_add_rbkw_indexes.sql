-- =====================================================
-- Performance Optimization: Add Indexes to rb_kw_olap
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_rbkw_crawl_platform_brand ON rb_kw_olap (
    kw_crawl_date,
    platform_name,
    brand_name
);
...
CREATE INDEX IF NOT EXISTS idx_rbkw_location_date ON rb_kw_olap (location_name, kw_crawl_date);
...
CREATE INDEX IF NOT EXISTS idx_rbkw_category_date ON rb_kw_olap (
    keyword_category,
    kw_crawl_date
);
...
CREATE INDEX IF NOT EXISTS idx_rbkw_platform ON rb_kw_olap (platform_name);
