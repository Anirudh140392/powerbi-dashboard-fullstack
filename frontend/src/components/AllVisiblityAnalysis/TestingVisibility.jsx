  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
      <div className="flex items-start justify-between px-4 pt-3">
          ...
          <div className="mt-1 flex items-baseline gap-2">
            ...
            <span
              className={`text-sm font-semibold ${
                deltaPeriod >= 0 ? "text-emerald-600" : "text-rose-600"
              }`}
            >
        ...
        <span
          className={`rounded-full px-3 py-1 text-xs font-semibold ${statusChip[status].className}`}
        >
      ...
      <div className="h-20 w-full px-2 pt-2">
        <ResponsiveContainer>
          ...
          >
            ...
            <Tooltip
              formatter={(v) => [`${v.toFixed(1)}%`, "Visibility Share"]}
            />
            <Area
              type="monotone"
              dataKey="value"
    ...
    <div className="mb-2 flex items-center justify-between">
      <div>
        <p className="text-sm font-semibold text-slate-800">
          Visibility Share trend by Year
        </p>
          ...
          <Bar dataKey="actual">
            {data.map((d, idx) => (
              <Cell
                key={d.year}
                fill={
                  idx > 0 && d.actual < data[idx - 1].actual
                    ? "#f97316"
                    : "#4f46e5"
                }
              />
        ...
        <ResponsiveContainer>
          <BarChart data={sorted} layout="vertical" margin={{ left: 50 }}>
            ...
            <Bar
              dataKey="value"
              radius={[0, 8, 8, 0]}
              onClick={(d) => onCountrySelect?.(d.code)}
            >
              {sorted.map((c) => (
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
      <div className="mb-2 flex items-center justify-between">
        <div>
          <p className="text-sm font-semibold text-slate-800">
            Visibility Share by Channel
          </p>
          <p className="text-xs text-slate-500">
            Stacked split: Organic vs Sponsored
          </p>
        </div>
...
const ProductHeatTable = ({ data }) => {
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
      <div className="mb-2 flex items-center justify-between">
        <p className="text-sm font-semibold text-slate-800">
          Visibility Share across Products
        </p>
                  ...
                  return (
                    <td key={col} className="px-2 py-2 text-right">
                      <div
                        ...
                        title={`Current: ${val.toFixed(
                          1
                        )}%\nLast: ${last.toFixed(1)}%\nΔ: ${delta.toFixed(
                          1
                        )} (${((delta / Math.max(last, 1)) * 100).toFixed(
                          1
                        )}%)`}
                      >
                        {val.toFixed(1)}%
...
const kpiData = {
  ...
  tiles: [
    {
      title: "Overall Visibility Share",
      value: 63.2,
      trend: [58.2, 59.8, 60.1, 61.0, 62.4, 63.2],
      delta: 1.4,
      target: 65,
      status: "at-risk",
    },
    {
      title: "Sponsored Visibility Share",
      value: 28.4,
      trend: [24.2, 25.4, 26.8, 27.1, 27.9, 28.4],
      delta: 0.9,
      target: 30,
      status: "on-track",
    },
    {
      title: "Organic Visibility Share",
      value: 34.8,
      trend: [32.0, 32.5, 32.9, 33.4, 34.0, 34.8],
      delta: 0.7,
      target: 35,
      status: "on-track",
    },
...
const productData = [
  {
    ...
    store: 21.4,
    web: 15.3,
    last: { distributor: 17.1, store: 20.2, web: 14.1 },
  },
  {
    product: "Lotion",
    distributor: 16.4,
    store: 18.1,
    web: 13.7,
    last: { distributor: 15.6, store: 17.4, web: 13.2 },
  },
  {
    product: "Hand Wash",
    distributor: 12.8,
    store: 14.5,
    web: 10.3,
    last: { distributor: 12.0, store: 13.9, web: 9.8 },
  },
  {
    product: "Face Wash",
    distributor: 10.5,
    store: 12.7,
    web: 8.6,
    last: { distributor: 9.9, store: 12.1, web: 8.1 },
  },
  {
    product: "Ice Cream",
    distributor: 11.7,
    store: 13.8,
    web: 9.2,
    last: { distributor: 10.9, store: 13.2, web: 8.9 },
  },
];
...
const pulseData = [
  {
    ...
    value: 0.9,
    delta: -0.6,
    trend: [1.1, 1.0, 0.98, 0.96, 0.93, 0.9],
    rank: 5,
    total: 32,
    severity: "warning",
  },
  {
    ...
    value: 1.0,
    delta: -0.3,
    trend: [1.1, 1.05, 1.03, 1.01, 1.0, 1.0],
    rank: 8,
    total: 32,
    severity: "normal",
  },
  {
    ...
    value: 1.3,
    delta: -0.2,
    trend: [1.2, 1.22, 1.25, 1.28, 1.3, 1.3],
    rank: 3,
    total: 32,
    severity: "normal",
  },
...
const categoryCards = [
  {
    ...
    deltaAd: -2.3,
    deltaDisplay: -0.4,
    trend: [1.2, 1.1, 1.0, 0.98, 0.94, 0.9],
    status: "down",
  },
  {
    name: "Shower Gel",
    ...
    deltaAd: -2.9,
    deltaDisplay: -1.0,
    trend: [2.8, 2.7, 2.6, 2.5, 2.45, 2.4],
    status: "down",
  },
  {
    name: "Hand Wash",
  ...
  },
  {
    ...
    deltaAd: 0.0,
    deltaDisplay: -0.2,
    trend: [0.5, 0.45, 0.4, 0.35, 0.32, 0.3],
    status: "down",
  },
];
...
const competitorSeries = [
  {
    ...
    color: "#ef4444",
    values: [
      { date: "06 Sep", value: 1.2 },
      { date: "10 Sep", value: 1.1 },
      { date: "14 Sep", value: 1.3 },
      { date: "18 Sep", value: 1.2 },
      { date: "22 Sep", value: 1.25 },
      { date: "26 Sep", value: 1.3 },
      { date: "30 Sep", value: 1.4 },
    ],
  },
  {
    name: "Dettol",
    color: "#a855f7",
    values: [
      { date: "06 Sep", value: 6.2 },
      { date: "10 Sep", value: 6.1 },
      { date: "14 Sep", value: 6.0 },
      { date: "18 Sep", value: 6.4 },
      { date: "22 Sep", value: 6.2 },
      { date: "26 Sep", value: 6.1 },
      { date: "30 Sep", value: 6.3 },
    ],
  },
  {
    name: "L'Oreal Paris",
    color: "#22c55e",
    values: [
      { date: "06 Sep", value: 9.1 },
      { date: "10 Sep", value: 9.3 },
      { date: "14 Sep", value: 9.4 },
      { date: "18 Sep", value: 9.6 },
      { date: "22 Sep", value: 9.5 },
      { date: "26 Sep", value: 9.8 },
      { date: "30 Sep", value: 9.7 },
    ],
  },
  {
    name: "Cetaphil",
    color: "#0ea5e9",
    values: [
      { date: "06 Sep", value: 3.2 },
      { date: "10 Sep", value: 3.1 },
      { date: "14 Sep", value: 3.0 },
      { date: "18 Sep", value: 3.2 },
      { date: "22 Sep", value: 3.1 },
      { date: "26 Sep", value: 3.3 },
      { date: "30 Sep", value: 3.4 },
    ],
  },
];
      ...
      <div className="mx-auto max-w-7xl space-y-4">
        ...
        {/* <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Premium analytics studio for Visibility Share
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="inline-flex rounded-full bg-slate-100 p-1 text-xs font-semibold text-slate-600">
              {["Overall", "Sponsored", "Organic"].map((m) => (
                <button
                  key={m}
                  className="px-3 py-1 rounded-full bg-white shadow-sm text-slate-900"
                >
                  {m}
                </button>
              ))}
            ...
            {categoryCards.map((cat) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-xs font-semibold ${
                      cat.status === "up" ? "text-emerald-600" : "text-rose-600"
                    }`}
                  >
                    {cat.status === "up" ? "▲" : "▼"}{" "}
                    {Math.abs(cat.deltaOverall).toFixed(1)}%
                  </span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2 text-[11px] text-slate-600">
                  <div>
                    <div className="font-semibold text-slate-800">
                      {cat.overall.toFixed(1)}%
                    </div>
                    <div className="text-rose-600">
                      {cat.deltaOverall.toFixed(1)}%
                    </div>
                  ...
                  <div>
                    ...
                    <div className="text-rose-600">
                      {cat.deltaAd.toFixed(1)}%
                    </div>
                    <div className="text-slate-500">Sponsored</div>
                  </div>
                  <div>
                    <div className="font-semibold text-slate-800">
                      {cat.display.toFixed(1)}%
                    </div>
                    <div className="text-rose-600">
                      {cat.deltaDisplay.toFixed(1)}%
                    </div>
                ...
                <div className="h-12 w-full">
                  <ResponsiveContainer>
                    <AreaChart
                      data={cat.trend.map((v, i) => ({ idx: i, value: v }))}
                      margin={{ top: 4, right: 6, left: -10, bottom: 0 }}
                    >
                      <XAxis dataKey="idx" hide />
                      <YAxis hide domain={["auto", "auto"]} />
                      <Tooltip
                        formatter={(v) => [`${v.toFixed(1)}%`, "Visibility"]}
                      />
                      <Area
                        type="monotone"
                        dataKey="value"
        ...
        <div className="grid gap-3 lg:grid-cols-2">
          ...
          <CountryBarChart
            data={countryData}
            avg={56.2}
            onCountrySelect={(code) => console.log("select country", code)}
          />
        </div>
          ...
          <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-4">
            {pulseData.map((p) => (
              <VisibilityPulseCard
                ...
                onInsights={() =>
                  setModal({ type: "insights", context: p.city })
                }
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          <div className="mb-2">
            ...
            <p className="text-xs text-slate-500">
              Drag fields, build ratios, and switch view.
            </p>
          </div>
            ...
            <div className="w-full max-w-5xl rounded-3xl border border-slate-200 bg-white p-4 shadow-2xl">
              <div className="mb-3 flex items-center justify-between">
                <div>
                  <p className="text-sm font-semibold text-slate-800 capitalize">
                    {modal.type} for {modal.context}
                  </p>
                  <p className="text-xs text-slate-500">Interactive view</p>
                </div>
                <button
                  onClick={() => setModal(null)}
                  className="rounded-full border border-slate-200 bg-slate-50 p-2"
                >
                    ...
                    <ResponsiveContainer>
                      <LineChart
                        data={competitorSeries[0].values.map((_, idx) => {
                          const point = {
                            date: competitorSeries[0].values[idx].date,
                          };
              ...
              {modal.type === "trends" && (
                <div className="h-80">
                  <ResponsiveContainer>
                    <LineChart
                      data={activeCategory.trend.map((v, i) => ({
                        idx: i,
                        Value: v,
                      }))}
                    >
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                    ...
                    <ul className="mt-2 space-y-1 text-xs">
                      {[
                        ...
                        <li
                          key={b}
                          className="flex items-center justify-between rounded-lg bg-white px-2 py-1"
                        >
                          <span>{b}</span>
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
                    ...
                    <ul className="mt-2 space-y-1 text-xs">
                      {[
                        ...
                        <li
                          key={b}
                          className="flex items-center justify_between rounded-lg bg-white px-2 py-1"
                        >
                          <span>{b}</span>
...
export default TestingVisibility;
export {
  KpiTile,
  YearTrendChart,
  CountryBarChart,
