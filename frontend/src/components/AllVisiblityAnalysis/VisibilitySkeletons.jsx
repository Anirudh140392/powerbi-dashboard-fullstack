                        ...
                        <table className="min-w-full">
                            <thead>
                                <tr className="bg-slate-50">
                                    <th className="px-3 py-3"><div className="h-4 w-24 bg-slate-200 rounded animate-pulse"></div></th>
                                    {[1, 2, 3, 4].map((col) => (
                                    ...
                                    <tr key={row} className="border-b border-slate-100">
                                        ...
                                        {[1, 2, 3, 4].map((col) => (
                                            <td key={col} className="px-3 py-4 text-center">
                                                <div className="h-6 w-12 bg-slate-100 rounded animate-pulse mx-auto"></div>
                                            </td>
                                        ))}
                                    </tr>
                                ))}
                ...
                <table className="w-full text-left border-collapse">
                    <thead>
                        <tr className="border-b border-slate-100 bg-slate-50/80">
                            ...
                            <th className="px-6 py-4 text-center"><div className="h-4 w-28 bg-slate-200 rounded animate-pulse mx-auto"></div></th>
                            <th className="px-6 py-4 text-center"><div className="h-4 w-28 bg-slate-200 rounded animate-pulse mx-auto"></div></th>
                            <th className="px-6 py-4 text-center"><div className="h-4 w-24 bg-slate-200 rounded animate-pulse mx-auto"></div></th>
                        </tr>
                    </thead>
                    <tbody>
