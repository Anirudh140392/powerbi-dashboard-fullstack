...
import CohortHeatmapDemo, {
  priceRecords,
  quantityRecords,
} from "../AllMarketShares/CohortHeatmap";
import {
  cleanPriceBands,
  cleanQuantityBands,
} from "../AllMarketShares/CohortBands";
...
const aggregateIndex = (records, allowed, mid) => {
  ...
  Object.entries(sums).forEach(([brand, val]) => {
    out[brand] = {
      total: val.total,
      index: val.total ? val.weighted / val.total : 0,
    };
  });
  return out;
};
...
const computeBrandPositions = () => {
  ...
  const brands = Array.from(
    new Set([...Object.keys(priceAgg), ...Object.keys(qtyAgg)])
  );
  return brands.map((brand) => {
    ...
    return {
      brand,
      priceIndex: Number(price.toFixed(1)),
      qtyIndex: Number(qty.toFixed(1)),
      sales,
    };
  });
};
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-600">
            Bubble = brand · X: price index · Y: quantity index · size: sales.
        ...
        <div className="flex flex-wrap gap-2 text-[10px] text-slate-600 justify-end">
          {data.slice(0, 8).map((d) => (
            <span
              key={d.brand}
              className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full border border-slate-200 bg-slate-50"
            >
              <span
                className="h-2 w-2 rounded-full"
                style={{ backgroundColor: brandColors[d.brand] || "#0ea5e9" }}
              />
              {d.brand}
            </span>
          ))}
            ...
            >
              ...
              <Tooltip
                ...
                formatter={(val, name) => {
                  ...
                  return [
                    val,
                    name === "priceIndex" ? "Price index" : "Quantity index",
                  ];
                }}
              />
              <Scatter
              ...
              >
                {data.map((entry) => (
                  <Cell
                    key={entry.brand}
                    fill={brandColors[entry.brand] || "#0ea5e9"}
                  />
                ))}
              </Scatter>
            </ScatterChart>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <span
                ...
                style={{
                  backgroundColor: brandColors[focused.brand] || "#0ea5e9",
                }}
              />
            ...
            <div className="text-xs text-slate-600">
              Price index: {focused.priceIndex.toFixed(1)}
            </div>
            <div className="text-xs text-slate-600">
              Quantity index: {focused.qtyIndex.toFixed(1)}
            </div>
            <div className="text-xs text-slate-600">
              Sales: ₹ {focused.sales.toLocaleString("en-IN")}
            </div>
            <div className="mt-1 text-[11px] text-slate-500">
              Size is relative to max sales ({maxSales.toLocaleString("en-IN")}
              ). Use this map as a front-door story, then drill to cohort
              heatmap below.
            </div>
          </motion.div>
        )}
...
const cityMonthData = [
  {
    ...
    region: "East",
    city: "Kolkata",
    values: { "Q1|Jan": 92, "Q1|Feb": 91, "Q2|Mar": 89, "Q2|Apr": 90 },
  },
  {
    platform: "Blinkit",
    region: "West",
    city: "Mumbai",
    values: { "Q1|Jan": 90, "Q1|Feb": 89, "Q2|Mar": 91, "Q2|Apr": 92 },
  },
  {
    platform: "Instamart",
    region: "South",
    city: "Hyderabad",
    values: { "Q1|Jan": 84, "Q1|Feb": 83, "Q2|Mar": 82, "Q2|Apr": 85 },
  },
  {
    platform: "Instamart",
    region: "South",
    city: "Bengaluru",
    values: { "Q1|Jan": 86, "Q1|Feb": 85, "Q2|Mar": 84, "Q2|Apr": 86 },
  },
  {
    platform: "Zepto",
    region: "West",
    city: "Mumbai",
    values: { "Q1|Jan": 93, "Q1|Feb": 92, "Q2|Mar": 90, "Q2|Apr": 91 },
  },
  {
    platform: "Zepto",
    region: "South",
    city: "Chennai",
    values: { "Q1|Jan": 90, "Q1|Feb": 89, "Q2|Mar": 88, "Q2|Apr": 90 },
  },
];
        ...
        days: [
          {
            day: 1,
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.3 },
              Instamart: { ola: 86, loss: 0.1, roas: 4.7 },
              "Virtual Store": { ola: 74, loss: 0.4, roas: 3.9 },
              Zepto: { ola: 93, loss: 0, roas: 5.6 },
            },
          },
          {
            day: 2,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.1 },
              Instamart: { ola: 83, loss: 0.2, roas: 4.3 },
              "Virtual Store": { ola: 73, loss: 0.5, roas: 3.7 },
              Zepto: { ola: 92, loss: 0, roas: 5.3 },
            },
          },
          {
            day: 3,
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.0 },
              Instamart: { ola: 84, loss: 0.1, roas: 4.5 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.8 },
              Zepto: { ola: 92, loss: 0, roas: 5.5 },
            },
          },
          {
            day: 4,
            values: {
              Blinkit: { ola: 89, loss: 0.1, roas: 4.8 },
              Instamart: { ola: 79, loss: 0.3, roas: 3.9 },
              "Virtual Store": { ola: 72, loss: 0.5, roas: 3.6 },
              Zepto: { ola: 89, loss: 0.1, roas: 5.1 },
            },
          },
          {
            day: 5,
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.2 },
              Instamart: { ola: 80, loss: 0.2, roas: 4.2 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.7 },
              Zepto: { ola: 91, loss: 0, roas: 5.4 },
            },
          },
          {
            day: 6,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.4 },
              Instamart: { ola: 81, loss: 0.2, roas: 4.4 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.7 },
              Zepto: { ola: 90, loss: 0.1, roas: 5.0 },
            },
          },
        ],
      },
        ...
        days: [
          {
            day: 7,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.5 },
              Instamart: { ola: 81, loss: 0.2, roas: 4.4 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.7 },
              Zepto: { ola: 91, loss: 0, roas: 5.2 },
            },
          },
          {
            day: 8,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.3 },
              Instamart: { ola: 82, loss: 0.2, roas: 4.5 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.8 },
              Zepto: { ola: 92, loss: 0, roas: 5.3 },
            },
          },
          {
            day: 9,
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.1 },
              Instamart: { ola: 82, loss: 0.2, roas: 4.6 },
              "Virtual Store": { ola: 72, loss: 0.5, roas: 3.6 },
              Zepto: { ola: 91, loss: 0, roas: 5.4 },
            },
          },
          {
            ...
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.0 },
              Instamart: { ola: 81, loss: 0.3, roas: 4.4 },
              "Virtual Store": { ola: 73, loss: 0.5, roas: 3.7 },
              Zepto: { ola: 91, loss: 0, roas: 5.3 },
            },
          },
        ],
      },
        ...
        days: [
          {
            day: 11,
            values: {
              Blinkit: { ola: 89, loss: 0.1, roas: 4.9 },
              Instamart: { ola: 82, loss: 0.2, roas: 4.6 },
              "Virtual Store": { ola: 73, loss: 0.5, roas: 3.8 },
              Zepto: { ola: 90, loss: 0.1, roas: 5.1 },
            },
          },
          {
            day: 12,
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.1 },
              Instamart: { ola: 82, loss: 0.2, roas: 4.7 },
              "Virtual Store": { ola: 73, loss: 0.4, roas: 3.8 },
              Zepto: { ola: 91, loss: 0, roas: 5.4 },
            },
          },
          {
            ...
            values: {
              ...
              Instamart: { ola: 82, loss: 0.2, roas: 4.6 },
              "Virtual Store": { ola: 73, loss: 0.5, roas: 3.7 },
              Zepto: { ola: 89, loss: 0.1, roas: 5.2 },
            },
          },
          {
            day: 14,
            values: {
              Blinkit: { ola: 89, loss: 0.1, roas: 4.9 },
              Instamart: { ola: 81, loss: 0.3, roas: 4.3 },
              "Virtual Store": { ola: 74, loss: 0.4, roas: 3.9 },
              Zepto: { ola: 90, loss: 0.1, roas: 5.1 },
            },
          },
        ...
        days: [
          {
            ...
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.1 },
              Instamart: { ola: 84, loss: 0.1, roas: 4.6 },
              "Virtual Store": { ola: 75, loss: 0.3, roas: 4.0 },
              Zepto: { ola: 92, loss: 0, roas: 5.5 },
            },
          },
          {
            day: 2,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.2 },
              Instamart: { ola: 84, loss: 0.1, roas: 4.5 },
              "Virtual Store": { ola: 75, loss: 0.3, roas: 4.0 },
              Zepto: { ola: 92, loss: 0, roas: 5.6 },
            },
          },
          {
            day: 3,
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.4 },
              Instamart: { ola: 85, loss: 0.1, roas: 4.8 },
              "Virtual Store": { ola: 75, loss: 0.3, roas: 4.1 },
              Zepto: { ola: 93, loss: 0, roas: 5.7 },
            },
          },
          {
            day: 4,
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.2 },
              Instamart: { ola: 83, loss: 0.2, roas: 4.4 },
              "Virtual Store": { ola: 75, loss: 0.3, roas: 4.0 },
              Zepto: { ola: 92, loss: 0, roas: 5.4 },
            },
          },
        ],
      },
        ...
        days: [
          {
            ...
            values: {
              Blinkit: { ola: 90, loss: 0, roas: 5.1 },
              Instamart: { ola: 82, loss: 0.2, roas: 4.3 },
              "Virtual Store": { ola: 76, loss: 0.3, roas: 4.1 },
              Zepto: { ola: 91, loss: 0, roas: 5.3 },
            },
          },
          {
            ...
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.2 },
              Instamart: { ola: 83, loss: 0.2, roas: 4.5 },
              "Virtual Store": { ola: 76, loss: 0.3, roas: 4.2 },
              Zepto: { ola: 93, loss: 0, roas: 5.6 },
            },
          },
          {
            ...
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.3 },
              Instamart: { ola: 84, loss: 0.2, roas: 4.6 },
              "Virtual Store": { ola: 77, loss: 0.3, roas: 4.3 },
              Zepto: { ola: 92, loss: 0, roas: 5.5 },
            },
          },
          {
            ...
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.4 },
              Instamart: { ola: 84, loss: 0.2, roas: 4.7 },
              "Virtual Store": { ola: 77, loss: 0.3, roas: 4.3 },
              Zepto: { ola: 93, loss: 0, roas: 5.7 },
            },
          },
        ...
        days: [
          {
            day: 9,
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.5 },
              Instamart: { ola: 85, loss: 0.1, roas: 4.8 },
              "Virtual Store": { ola: 78, loss: 0.3, roas: 4.5 },
              Zepto: { ola: 94, loss: 0, roas: 5.9 },
            },
          },
          {
            day: 10,
            values: {
              Blinkit: { ola: 91, loss: 0, roas: 5.4 },
              Instamart: { ola: 84, loss: 0.2, roas: 4.6 },
              "Virtual Store": { ola: 78, loss: 0.3, roas: 4.4 },
              Zepto: { ola: 93, loss: 0, roas: 5.7 },
            },
          },
          {
            day: 11,
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.6 },
              Instamart: { ola: 85, loss: 0.1, roas: 4.8 },
              "Virtual Store": { ola: 78, loss: 0.3, roas: 4.5 },
              Zepto: { ola: 94, loss: 0, roas: 6.0 },
            },
          },
          {
            day: 12,
            values: {
              Blinkit: { ola: 92, loss: 0, roas: 5.5 },
              Instamart: { ola: 85, loss: 0.1, roas: 4.9 },
              "Virtual Store": { ola: 78, loss: 0.3, roas: 4.5 },
              Zepto: { ola: 94, loss: 0, roas: 6.0 },
            },
          },
...
const getFirstCity = (platform, region) =>
  getCityNames(platform, region)[0] || "";
    ...
    <div className="rounded-2xl bg-white shadow-sm border border-slate-100 p-4 flex flex-col gap-4">
      ...
      <section className="grid grid-cols-12 gap-4">
        ...
        <motion.div
          ...
          className="col-span-12 lg:col-span-12 rounded-2xl bg-white shadow-sm border border-slate-100 px-4 py-3"
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-[11px] text-slate-400">
              Tap a ring to focus drill-down
            </p>
          </div>
...
const MatrixPlatformFormat = () => {
  ...
  const regionsFor = (p) =>
    Array.from(
      new Set(
        cityMonthData.filter((r) => r.platform === p).map((r) => r.region)
      )
    );
  const citiesFor = (p, r) =>
  ...
  const selectionMeta = useMemo(() => {
    ...
    const quarterRows = cityMonthData.filter(
      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          <p className="text-xs uppercase tracking-[0.16em] text-slate-400">
            Platform Level Ola Accross Platform
          </p>
          <p className="text-xs text-slate-500">
...
const PowerHierarchyHeat = () => {
  ...
  const platforms = useMemo(
    () => Array.from(new Set(cityFormatData.map((r) => r.platform))),
    []
  );
  const regionsForPlatform = (p) =>
    Array.from(
      new Set(
        cityFormatData.filter((r) => r.platform === p).map((r) => r.region)
      )
    );
  const citiesFor = (p, r) =>
    cityFormatData.filter((row) => row.platform === p && row.region === r);
        ...
        <table className="min-w-full text-[12px]">
          ...
          <tbody>
            {platforms.map((platform) => {
              ...
              const platformRows = cityFormatData.filter(
    ...
    <div className="rounded-3xl bg-white border border-slate-100 shadow-[0_10px_36px_rgba(15,23,42,0.06)] p-5 flex flex-col gap-3">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-600">
            Drill from quarter to month days with KPI-aware heat.
          </p>
        </div>
      ...
      <p className="text-xs text-slate-500">
        {kpiModes[activeKpi].description}
      </p>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500">
                      Tap plus to reveal months & days.
                    </p>
                  </div>
                </div>
                        ...
                        <thead>
                          <tr className="bg-slate-50/70">
                            ...
                            {quarter.months.map((m) => (
                              <th
                                key={m.name}
                                className="px-3 py-2 text-center font-semibold text-slate-600"
                            ...
                            >
                              <td className="px-3 py-2 text-slate-700 font-semibold whitespace-nowrap">
                                ...
                                <span className="ml-2 text-[10px] text-slate-400">
                                  avg{" "}
                                  {formatMetric(
                                    averageForQuarter(quarter, platform)
                                  )}
                                </span>
                              </td>
                              {quarter.months.flatMap((m) =>
...
const FormatDrillDownTable = () => {
  ...
  const [city, setCity] = useState(
    getFirstCity("Blinkit", getFirstRegion("Blinkit"))
  );

  const regions = useMemo(() => getRegionNames(platform), [platform]);
  const cities = useMemo(
    () => getCityNames(platform, region),
    [platform, region]
  );
  ...
  return (
    <div className="rounded-2xl bg-gradient-to-br from-slate-50 via-white to-slate-50 shadow-[0_12px_50px_rgba(15,23,42,0.08)] border border-slate-100 p-5 flex flex-col gap-4">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          <span className="px-3 py-2 rounded-full bg-white border border-slate-200 shadow-sm">
            Expanded path:
          </span>
          <select
      ...
      <div className="flex flex-wrap gap-2 text-[11px] text-slate-500">
        ...
        <span className="px-2 py-1 rounded-full border border-slate-200 bg-slate-50">
          Format tab: {activeTab}
        </span>
        <span className="px-2 py-1 rounded-full border border-slate-200 bg-slate-50">
          Tap a row to expand platforms.
        </span>
      </div>
      ...
      <div className="overflow-x-auto rounded-xl border border-slate-100">
        <table className="min-w-full text-[12px]">
          <thead className="bg-slate-50">
            <tr className="text-left">
              <th className="px-3 py-2 font-semibold text-slate-600 w-40">
                Format
              </th>
              <th className="px-3 py-2 font-semibold text-slate-600 text-center">
                Spend
              </th>
              <th className="px-3 py-2 font-semibold text-slate-600 text-center">
                M-1 Spend
          ...
          <tbody>
              ...
              <React.Fragment key={row.name}>
                <tr className="border-t border-slate-100">
                  ...
                  {[row.spend, row.m1Spend, row.m2Spend].map((v, idx) => (
                    <td key={idx} className="px-3 py-2 text-center">
                      <span
                        className={`px-2 py-1 rounded ${spendCellColor(v)}`}
                      >
                        {v.toFixed(1)}
                      </span>
                    </td>
                  ))}
                  {[row.conversion, row.m1Conversion, row.m2Conversion].map(
                    (v, idx) => (
                      <td key={idx} className="px-3 py-2 text-center">
                        <span
                          className={`px-2 py-1 rounded ${pctCellColor(v)}`}
                        >
                          {v.toFixed(1)}%
                        </span>
                      </td>
                ...
                {row.children &&
                  ...
                  row.children.map((child) => (
                    ...
                    >
                      <td className="px-3 py-2 text-slate-700 pl-8">
                        • {child.name}
                      </td>
                      {[child.spend, child.m1Spend, child.m2Spend].map(
                        (v, idx) => (
                          <td key={idx} className="px-3 py-2 text-center">
                            <span
                              className={`px-2 py-1 rounded ${spendCellColor(
                                v
                              )}`}
                            >
                              {v.toFixed(1)}
            ...
            <tr className="border-t border-slate-200 bg-slate-100 font-semibold text-slate-800">
              ...
              <td className="px-3 py-2 text-center">
                {totals.spend.toFixed(1)}
              </td>
              <td className="px-3 py-2 text-center">
                {totals.m1Spend.toFixed(1)}
              </td>
              <td className="px-3 py-2 text-center">
                {totals.m2Spend.toFixed(1)}
              </td>
