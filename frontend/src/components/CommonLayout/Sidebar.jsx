      ...
      <Box sx={{
        ...
        <Box
          sx={{
            ...
            width: '100%',
            height: isCollapsed ? 50 : (user?.dbName === 'mars_petcare' ? 150 : (user?.dbName === 'mamaearth' ? 100 : ((user?.dbName === 'zydus' || user?.dbName === 'hm_zydus') ? 80 : (user?.dbName === 'sugar' ? 80 : (user?.dbName === 'pidilite' ? 80 : 60))))),
          }}
        >
          <Box
            sx={{
          ...
          >
            {user?.dbName !== 'mars' && (
              <img
                ...
                alt={activeLogoAlt}
                style={{
                  maxHeight: isCollapsed ? '32px' : (user?.dbName === 'mamaearth' ? '100px' : (user?.dbName === 'mars_petcare' ? '150px' : ((user?.dbName === 'zydus' || user?.dbName === 'hm_zydus') ? '80px' : (user?.dbName === 'sugar' ? '80px' : (user?.dbName === 'pidilite' ? '80px' : '45px'))))),
                  width: isCollapsed ? '100%' : 'auto',
                  maxWidth: isCollapsed ? '42px' : (user?.dbName === 'mamaearth' ? '240px' : (user?.dbName === 'mars_petcare' ? '250px' : ((user?.dbName === 'zydus' || user?.dbName === 'hm_zydus') ? '220px' : (user?.dbName === 'sugar' ? '220px' : (user?.dbName === 'pidilite' ? '220px' : '180px'))))),
                  objectFit: 'contain',
                  padding: '0',
                  display: 'block',
