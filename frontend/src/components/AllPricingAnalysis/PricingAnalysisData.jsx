...
export default function PricingAnalysisData() {
  ...
  const filterDeps = [globalPlatform, selectedLocation, selectedCategory, selectedChannel, selectedBrand, filters.brand, timeStart, timeEnd, datesInitialized, selectedMsl, selectedSapCode];
