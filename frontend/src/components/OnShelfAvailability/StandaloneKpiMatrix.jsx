...
// Standalone copy of SubCategoryMarket (KPI Matrix) for On-Shelf Availability page.
...
const StandaloneKpiMatrix = ({ loading: parentLoading }) => {
    ...
    useEffect(() => {
        const fetchSubCategoryKpi = async () => {
            ...
            try {
                ...
                console.log("[StandaloneKpiMatrix] Sub-Category KPI Data:", response.data);
                ...
                console.error("[StandaloneKpiMatrix] Error fetching Sub-Category KPI data:", error);
            } finally {
...
export default StandaloneKpiMatrix;
