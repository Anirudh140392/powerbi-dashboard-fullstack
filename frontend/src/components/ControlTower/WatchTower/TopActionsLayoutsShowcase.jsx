...
const DetailPanel = ({ selected }) => {
    ...
    const Header = () => (
        <div className="flex flex-col sm:flex-row items-baseline sm:items-center justify-between gap-2">
            <div>
                ...
                <h2 className="mt-0.5 text-base sm:text-lg font-semibold text-slate-900" style={{ fontFamily: "Roboto, sans-serif", fontWeight: 700 }}>
                    {selected.label}
                </h2>
                <p className="text-[10px] sm:text-xs text-slate-500" style={{ fontFamily: "Roboto, sans-serif", fontWeight: 400 }}>{selected.subtitle}</p>
            </div>
            <div className="flex flex-row sm:flex-col items-center sm:items-end gap-2">
                <span className="rounded-full bg-rose-50 px-2 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-xs font-semibold text-rose-600">
                    {selected.leak}
                </span>
                <span className="rounded-full bg-slate-50 px-2 py-0.5 text-[9px] sm:text-[10px] font-medium text-slate-500">
                    {selected.tag}
                </span>
            </div>
        </div>
    ...
    return (
        <div className="relative flex h-full flex-col gap-3 sm:gap-4 rounded-2xl border border-slate-100 bg-white/80 p-3 sm:p-5 shadow-sm">
            <Header />
...
const LayoutOne = () => {
    ...
    return (
        <section className="grid gap-4 rounded-3xl bg-white p-3 sm:p-5 shadow-sm grid-cols-1 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.4fr)]">
            <div className="flex flex-col gap-3 bg-white">

                <div className="flex flex-col sm:flex-row items-baseline sm:items-center justify-between gap-2">
                    <div>
                        <h2 className="text-base sm:text-lg font-semibold text-slate-900" style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 700 }}>
                            Top actions – top actions for today
                        </h2>
                        <p className="text-[10px] sm:text-xs text-slate-500" style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 400 }}>
                            Ranked by 7-day leak and opportunity.
                        </p>
                    </div>

                    <button className="rounded-full border border-slate-200 bg-white px-3 py-1 text-[10px] sm:text-[11px] font-medium text-slate-600 shadow-xs" style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 500 }}>
                        View full playbook
                    </button>
                </div>
...
const TopActionsLayoutsShowcase = () => {
    return (
        <div className="w-full bg-white p-2 sm:p-4" style={{ fontFamily: 'Roboto, sans-serif' }}>
            <LayoutOne />
        </div>
    );
};
