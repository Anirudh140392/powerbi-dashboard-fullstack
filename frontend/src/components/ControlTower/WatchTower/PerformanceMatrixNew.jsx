...
const PerformanceMatrixNew = () => {
    ...
    const COMPARISON_KPIS = [
        { id: 'offtake', title: 'Offtakes', value: '₹14.8 Cr', delta: 15.9, deltaLabel: '+₹89.3 lac', icon: ShoppingCart, gradient: ['#6366f1', '#8b5cf6'], trend: [30, 35, 32, 45, 50, 48, 55, 60, 58, 65, 70, 75] },
        ...
        { id: 'market', title: 'Mkt Share', value: '24.3%', delta: 3.9, deltaLabel: '+0.92%', icon: PieChart, gradient: ['#8b5cf6', '#a855f7'], trend: [20, 21, 21.5, 22, 22.5, 23, 23.2, 23.5, 23.8, 24, 24.2, 24.3] },
        { id: 'sos', title: 'SOS', value: '25%', delta: -1.3, deltaLabel: '-0.4%', icon: Eye, gradient: ['#f97316', '#fb923c'], trend: [28, 27, 26.5, 26, 25.5, 25.8, 25.3, 25.1, 25.4, 25.2, 25.1, 25] },
