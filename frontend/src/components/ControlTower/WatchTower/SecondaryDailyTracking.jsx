...
export default function SecondaryDailyTracking({ timeStart, timeEnd }) {
  ...
  return (
    <Box sx={{ width: "100%", mt: 4 }}>
      ...
      {/* CARD 1: MRP SALES (DAILY HIGH-RESOLUTION AREA CHART) */}
      <Card
        sx={{
          borderRadius: 3,
          ...
          {loading ? (
            ...
            <Box sx={{ width: "100%", height: 300 }}>
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={dailyMrpData} margin={{ top: 25, right: 15, left: -15, bottom: 40 }}>
                  <defs>
                    <linearGradient id="mrpDailyGrad" x1="0" y1="0" x2="0" y2="1">
            ...
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", height: 300 }}>
              <Typography sx={{ fontSize: "0.85rem", color: "#94a3b8" }}>No data available</Typography>
            </Box>
          )}
        </CardContent>
      </Card>
