...
export default function WatchTower() {
  ...
  const KPI_INFO_TOOLTIPS = {
    ...
    'Share of Search': "The share of a brand’s presence within the top search results for relevant keywords or categories.",
    'Market Share': "The percentage of total category sales contributed by a brand.",
